@echo off
title Administrative Law Guide Server Launcher
echo ======================================
echo   Launching Administrative Law Guide
echo ======================================
echo.
echo This will start a local web server to run the Administrative Law Guide.
