...
# Configuration
PORT = 8000
DIRECTORY = "AdminLawGuide"  # Directory containing the guide
OPENER_MESSAGE = """
=========================================================
       ADMINISTRATIVE LAW GUIDE SERVER
=========================================================
...
def find_directory():
    """Find the AdminLawGuide directory relative to the script location"""
    ...
    # Check if the script is in the AdminLawGuide directory
...
class Handler(http.server.SimpleHTTPRequestHandler):
    def __init__(self, *args, **kwargs):
        # Set the server directory to the AdminLawGuide directory
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nServer stopped. Thank you for using the Administrative Law Guide!")
        sys.exit(0)
    except OSError as e:
